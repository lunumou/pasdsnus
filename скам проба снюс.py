...
tovar1 = ('Corvus - 250₽') # товар в каталоге
tovar2 = ('Ice Cool - 200₽')
...
op = ('@fichering') # Ник телеграмма оператора
numb = ('+79995444873') # Фейк Номер телефона
oplata = ('+79995444873')
...
bot = telebot.TeleBot('1327009154:AAEpijixchXUk6ZEQSmKPJ0ldJIruA2GcSE') # токен бота
